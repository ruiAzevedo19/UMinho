...
{
  "$end", "error", "$undefined", "DEF", "SIN", "TRD", "WORD", "$accept",
  "DICIONARIO", "PALAVRAS", "PALAVRA", "NOME", "ARGUMENTOS", "ARGUMENTO", 0
};
#endif
  ...
  switch (yyn)
    {
        case 3:
#line 62 "sati.y"
    {dic = insert_word(dic,pal);}
    break;

  case 6:
#line 67 "sati.y"
    {pal = create_word() ; add_name(pal,(yyvsp[(1) - (1)].texto));}
    break;

  case 9:
#line 72 "sati.y"
    {add_def(pal,(yyvsp[(1) - (1)].texto));}
    break;

  case 10:
#line 73 "sati.y"
    {add_trd(pal,(yyvsp[(1) - (1)].texto));}
    break;

  case 11:
#line 74 "sati.y"
    {add_sin(pal,(yyvsp[(1) - (1)].texto));}
    break;
