...
public class Utilizador implements Comparable<Utilizador>, Serializable {
    ...
    private final Queue<Map.Entry<Double , Encomenda>> encomendasDeTransportadoras = new ArrayDeque<>();
    ...
    @Override
    public int hashCode() {
        return Objects.hash(codigo, nome, local, historico, encomendasClassificadas, encomendasPorClassificar, encomendasDeTransportadoras);
    }
