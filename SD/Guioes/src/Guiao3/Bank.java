...
public class Bank implements BankInterface{
     ...
     * @throws NotEnoughFunds
     */
    public void credit(int id, double amount) throws InvalidAccount, NotEnoughFunds{
        this.bank_lock.lock();
        if( !this.accounts.containsKey(id) ){
            this.bank_lock.unlock();
            throw new InvalidAccount("A conta com o ID " + id + " não existe!");
     ...
     * @throws InvalidAccount
     */
    public void debit(int id, double amount) throws InvalidAccount{
        this.bank_lock.lock();
        if( !this.accounts.containsKey(id) ){
            this.bank_lock.unlock();
            throw new InvalidAccount("A conta com o ID " + id + " não existe!");
